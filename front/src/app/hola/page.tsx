...
export default function ProductsPage() {
  ...
  return (
    <div className="p-6 pt-24"> {/* pt-24 da un padding-top extra para que no tape el navbar */}
  <h1 className="text-3xl font-bold mb-6">Todos los Productos</h1>
  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
    {products.map((product) => (
      <div key={product.id} className="border rounded overflow-hidden shadow hover:shadow-lg transition-shadow duration-300">
        <Image
