...
// export const DB_DROP: boolean = process.env.DB_DROP?.toLowerCase() === "true";
import "dotenv/config";

export const PORT: number =
  process.env.PORT ? parseInt(process.env.PORT, 10) : 3002;

// YA NO USÁS VARIABLES MANUALES DE POSTGRES
// TODO EL BACKEND USA SOLO process.env.DATABASE_URL
